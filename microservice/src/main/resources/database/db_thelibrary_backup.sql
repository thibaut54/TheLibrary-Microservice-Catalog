...
-- Started on 2020-01-26 12:35:03
...
DROP DATABASE db_thelibrary;
--
-- TOC entry 2935 (class 1262 OID 196222)
-- Name: db_thelibrary; Type: DATABASE; Schema: -; Owner: -
--

CREATE DATABASE db_thelibrary WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'French_France.1252' LC_CTYPE = 'French_France.1252';


\connect db_thelibrary
...
--
-- TOC entry 4 (class 2615 OID 196616)
