...
public class CoordinatesMapperImpl implements CoordinatesMapper {
    ...
    public CoordinatesDTO coordionatesToDTO(CoordinatesEntity coordionatesEntity) {
        ...
        coordinatesDTO.user( userEntityToUserDTO( coordionatesEntity.getUser() ) );
    ...
    public CoordinatesEntity coordionatesToEntity(CoordinatesDTO coordionatesDTO) {
        ...
        coordinatesEntity.user( userDTOToUserEntity( coordionatesDTO.getUser() ) );
    ...
    protected UserDTO userEntityToUserDTO(UserEntity userEntity) {
        ...
        userDTO.coordinates( coordionatesToDTO( userEntity.getCoordinates() ) );
    ...
    protected UserEntity userDTOToUserEntity(UserDTO userDTO) {
        ...
        userEntity.coordinates( coordionatesToEntity( userDTO.getCoordinates() ) );
