...
public class BookMapperImpl implements BookMapper {
    ...
    public BookDTO toDTO(BookEntity bookEntity) {
        ...
        bookDTO.authorList( authorEntityListToAuthorDTOList( bookEntity.getAuthorList() ) );
    ...
    public BookEntity toEntity(BookDTO bookDTO) {
        ...
        bookEntity.authorList( authorDTOListToAuthorEntityList( bookDTO.getAuthorList() ) );
    ...
    protected AuthorDTO authorEntityToAuthorDTO(AuthorEntity authorEntity) {
        ...
        authorDTO.bookList( toDTOList( authorEntity.getBookList() ) );

        return authorDTO.build();
    }

    protected List<AuthorDTO> authorEntityListToAuthorDTOList(List<AuthorEntity> list) {
        if ( list == null ) {
            return null;
        }
        ...
        for ( AuthorEntity authorEntity : list ) {
            list1.add( authorEntityToAuthorDTO( authorEntity ) );
        }
    ...
    protected AuthorEntity authorDTOToAuthorEntity(AuthorDTO authorDTO) {
        if ( authorDTO == null ) {
            return null;
        }
        ...
        authorEntity.bookList( toEntityList( authorDTO.getBookList() ) );

        return authorEntity.build();
    }

    protected List<AuthorEntity> authorDTOListToAuthorEntityList(List<AuthorDTO> list) {
        if ( list == null ) {
            return null;
        }
        ...
        for ( AuthorDTO authorDTO : list ) {
            list1.add( authorDTOToAuthorEntity( authorDTO ) );
        }
